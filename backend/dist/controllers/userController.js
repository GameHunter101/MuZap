...
// @access	Private
const userGet = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { _id, name, email } = yield userModel_1.default.findById(req.user.id);
    res.status(200).json({
        id: _id,
        name,
        email
